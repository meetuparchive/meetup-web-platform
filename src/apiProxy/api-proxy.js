...
console.log('WTF AM I NOT HERE!!!!');
	return request => {
		console.log('HWERWERWWERWER    ');
...
console.log('REQUEST BEING MADE', queries, externalRequestOpts);
...
console.log('API CONFIG', apiConfigToRequestOptions);
