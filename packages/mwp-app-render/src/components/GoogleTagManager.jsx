...
/*
 * @description Gets google tag manager content (script or noscript)
 * @param {String} 'script' or 'noscript', indicating which GTM chunk to return
 * @param {Boolean} rtf Whether or not the runtime flag is on
 * @param {Boolean} isProd Whether or not to production environment
 * @see {@link https://developers.google.com/tag-manager/quickstart}
 *
 * @example
 * <head>
