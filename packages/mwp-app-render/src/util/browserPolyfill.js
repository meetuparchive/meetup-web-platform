 ...
 */
export const polyfillServiceUrl = (localeCode) => {
	const features = [
 ...
 */
export const getPolyfill = (userAgent, localeCode) => !userAgentPolyfillBlacklist.some(ua => userAgent.includes(ua)) && polyfillServiceUrl(localeCode);
